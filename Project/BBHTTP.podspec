Pod::Spec.new do |s|
  ...
  s.source   = { :git => "https://github.com/brunodecarvalho/BBHotpotato.git", :commit => "c11925f1c1" }

  s.requires_arc = true

  s.ios.deployment_target = "5.0"
  s.ios.source_files = "../BBHTTP/**/*.{h,m}", "../External/libcurl.iOS/*.h"
  ...
  s.osx.source_files = "../BBHTTP/**/*.{h,m}", "../External/libcurl.OSX/*.h"
  s.osx.frameworks = %w{ Security CoreServices AppKit }
  s.osx.libraries = %w{ z curl.OSX.a }
  s.osx.xcconfig = {
    # "HEADER_SEARCH_PATHS" => '"${PODS_ROOT}/External/libcurl.OSX"',
